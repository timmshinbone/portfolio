...
export default function Home() {
  return (
    <>
      <Head>
        <title>Timm Schoenborn Portfolio</title>
          ...
          <div className='flex items-center justify-between w-full lg:flex-col'>
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              ...
              <p className='my-4 text-base font-medium md:text-sm sm:text-xs'>
                As a skilled designer, full-stack developer, and project manager, I am dedicated to turning ideas into innovative web applications. Explore my latest projects and articles, showcasing my expertise in Javascript, React.js, Django and web development.
              </p>
