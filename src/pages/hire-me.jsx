...
const FeaturedService = ({ title, description, price, image, index }) => (
  <motion.li
    className="relative col-span-12 sm:col-span-6 p-4 bg-light dark:bg-dark border border-solid border-dark dark:border-light rounded-2xl"
  ...
  return (
    <>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center dark:text-light">
        <h1 className="inline-block w-full text-center text-6xl font-bold capitalize mt-16 mb-16 text-dark dark:text-light">Hire Me</h1>

        <ul className="grid grid-cols-12 gap-16 px-6 max-w-6xl">
        ...
        <motion.section
          className="w-full max-w-6xl mt-32 p-6 bg-light dark:bg-dark border border-dark dark:border-light rounded-xl shadow-lg"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
